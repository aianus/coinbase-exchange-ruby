...
describe Orderbook, vcr: vcr_options do
  ...
  context 'match' do
    it "correctly processes a trade" do
      message = {
          "maker_order_id" => "8af6743a-bd07-43fd-a8ab-c4bc9bcf2524",
          "taker_order_id" => "132fb6ae-456b-4654-b4e0-d681ac05cea1",
          "size" => "0.01",
          "side" => "buy"
      }

      orderbook.match(message)

      expect(orderbook.bids.first[Orderbook::PRICE]).to eq(BigDecimal.new("627.53"))
      expect(orderbook.bids.first[Orderbook::SIZE]).to eq(BigDecimal.new("0.00022184"))
      expect(orderbook.bids.first[Orderbook::ORDER_ID]).to eq("8af6743a-bd07-43fd-a8ab-c4bc9bcf2524")
    end
  end
end
